using AutoMapper;
using EMS.Common.Mappings;
using EMS.Data.Contracts;
using EMS.Data.DataContext;
using EMS.Data.Implementation;
...
namespace EMS.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EMSContext>(options => options.UseSqlServer(Configuration.GetConnectionString("IdentityConnection")));
